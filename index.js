...
function sumInput() {
    ...
    if (isNaN(number) || number == "" || number.match(/\s/)) {
        ...
        number.onchahge = document.querySelector('.text').innerHTML = "Введите следующее значение:";
    ...
    button.onclick = function getResult() {
        countNumbers.sort();
        document.querySelector('.result1').innerHTML = (`Массив в отсортированном по возрастанию виде: ${countNumbers}`);
    ...
    buttonCancel.onclick = function clearResult() {
        ...
        document.querySelector('.text').innerHTML = "Введите первое значение и нажмите ок:";
    }
}
